...
const PC1ROT: [[u64; 16]; 16] = [[0x0000000000000000,
                                  0x0000000000000000,
                                  0x0000010000000000,
                                  0x0000010000000000,
                                  0x0000000100000000,
...
const PC2ROT: [[[u64; 16]; 16]; 2] = [[[0x0000000000000000,
                                        0x0000800000000000,
                                        0x0800000000000000,
                                        0x0800800000000000,
                                        0x0000004000000000,
...
const IE3264: [[u64; 16]; 8] = [[0x0000000000000000,
                                 0x0000000000004004,
                                 0x0400000000000040,
                                 0x0400000000004044,
                                 0x0000000040040000,
...
const CF6464: [[u64; 16]; 16] = [[0x0000000000000000,
                                  0x0000000000000040,
                                  0x0000000000004000,
                                  0x0000000000004040,
                                  0x0000000000400000,
...
const SPE: [[u64; 64]; 8] = [[0x0080088008200000,
                              0x0000008008000000,
                              0x0000000000200020,
                              0x0080088008200020,
                              0x0000000000200000,
...
pub fn des_cipher(input: u64, keyword: u64, salt: u32, mut num_iter: u32) -> u64 {
    let salt = ((salt << 26) & 0xFC000000) | ((salt << 12) & 0xFC0000) | ((salt >> 2) & 0xFC00) |
               ((salt >> 16) & 0xFC);
    let mut L = input;
    let mut R = L;
